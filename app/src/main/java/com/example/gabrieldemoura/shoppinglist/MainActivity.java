package com.example.gabrieldemoura.shoppinglist;
...
public class MainActivity extends AppCompatActivity {
            ...
            alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (item_name.getText().toString().isEmpty() ||
                        ...
                        storeArrayVal(itemsList, getApplicationContext());
    ...
    public ArrayList<Item> fill_with_data() {
    ...
    public static void storeArrayVal(ArrayList<Item> inArrayList, Context context)
    {
        Set<Item> WhatToWrite = new HashSet<Item>(inArrayList);
    ...
    public static ArrayList getArrayVal (Context gabe)
    {
        SharedPreferences WordSearchGetPrefs = gabe.getSharedPreferences("dbArrayValues",Activity.MODE_PRIVATE);
        Set<Item> tempSet = new HashSet<Item>();
        tempSet = WordSearchGetPrefs.getStringSet("myArray", tempSet);
        return new ArrayList<Item>(tempSet);
    }
